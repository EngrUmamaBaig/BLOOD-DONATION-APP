...
public class RecipientRegistrationActivity extends AppCompatActivity {
    ...
    private TextInputEditText registerFullName,registerIdNumber,registerPhoneNumber,registerEmail;
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(bloodGroup.equals("Select Your Blood Group")){
                    Toast.makeText(RecipientRegistrationActivity.this,"Must Select Blood Group",Toast.LENGTH_SHORT).show();
                    return;
                }
                else
                {
                    ...
                    mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            else
                            {
                                ...
                                userInfo.put("profilepictureurl",profile_image);
                                ...
                                if (resultUri != null)
                                {
                                    ...
                                    uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                        ...
                                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                            if (taskSnapshot.getMetadata() != null && taskSnapshot.getMetadata()
                                                    .getReference() != null){
